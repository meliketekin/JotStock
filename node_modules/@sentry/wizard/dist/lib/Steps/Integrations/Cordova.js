...
var Cordova = /** @class */ (function (_super) {
    ...
    function Cordova(_argv) {
        var _this = _super.call(this, _argv) || this;
        _this._argv = _argv;
        _this._folderPrefix = 'platforms';
        _this._pluginFolder = ['.'];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, File_1.patchMatchingFile(this._folderPrefix + "/ios/*.xcodeproj/project.pbxproj", this._patchXcodeProj.bind(this))];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this._addSentryProperties(sentryCliProperties)];
                    case 2:
                        _a.sent();
    ...
    Cordova.prototype.uninstall = function (_answers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, File_1.patchMatchingFile('**/*.xcodeproj/project.pbxproj', this._unpatchXcodeProj.bind(this))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, {}];
                }
    ...
    Cordova.prototype.shouldConfigure = function (_answers) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
    ...
    Cordova.prototype._unpatchXcodeProj = function (filename) {
        var _this = this;
    ...
    Cordova.prototype._unpatchXcodeBuildScripts = function (proj) {
    ...
    Cordova.prototype._patchXcodeProj = function (contents, filename) {
        var _this = this;
        var proj = xcode.project(filename);
        return new Promise(function (resolve, reject) {
            proj.parse(function (err) {
                ...
                _this._addNewXcodeBuildPhaseForStripping(buildScripts, proj);
    ...
    Cordova.prototype._addNewXcodeBuildPhaseForSymbols = function (buildScripts, proj) {
    ...
    Cordova.prototype._addNewXcodeBuildPhaseForStripping = function (buildScripts, proj) {
    ...
    Cordova.prototype._addSentryProperties = function (properties) {
        var _this = this;
