...
var MobileProject = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        isPlatformSet = this._argv.platform &&
                            Array.isArray(this._argv.platform) &&
                            this._argv.platform.length;
                        _a = this;
                        if (!isPlatformSet) return [3 /*break*/, 1];
                        _b = this._argv.platform;
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this._platformSelector()];
                    case 2:
                        _b = (_c.sent()).platform;
                        _c.label = 3;
                    case 3:
                            ...
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
                                        ...
                                        _b = platform;
                                        if (!(_.indexOf(this._platforms, platform) >= 0)) return [3 /*break*/, 2];
                                        return [4 /*yield*/, this._shouldConfigurePlatform(platform)];
                                    case 1:
                                        _c = _d.sent();
                                        return [3 /*break*/, 3];
                                    case 2:
    ...
    MobileProject.prototype._platformSelector = function () {
        if (this._argv.quiet) {
