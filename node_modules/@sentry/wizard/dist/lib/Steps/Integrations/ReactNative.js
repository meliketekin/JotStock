...
var ReactNative = /** @class */ (function (_super) {
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                ...
                                                case 1:
                                                    ...
                                                    return [3 /*break*/, 4];
                                                case 2: return [4 /*yield*/, File_1.patchMatchingFile('**/app/build.gradle', this._patchBuildGradle.bind(this))];
                                                case 3:
                                                    _a.sent();
                                                    Logging_1.dim("\u2705 Patched build.gradle file.");
                                                    _a.label = 4;
                                                case 4: return [4 /*yield*/, File_1.patchMatchingFile("index." + platform + ".js", this._patchJs.bind(this), answers, platform)];
                                                case 5:
                                                    _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, File_1.patchMatchingFile('**/app/build.gradle', this._unpatchBuildGradle.bind(this))];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, {}];
                }
    ...
    ReactNative.prototype._patchBuildGradle = function (contents) {
        ...
        return Promise.resolve(contents.replace(/^apply from: "..\/..\/node_modules\/react-native\/react.gradle"/m, 
        // eslint-disable-next-line prefer-template
