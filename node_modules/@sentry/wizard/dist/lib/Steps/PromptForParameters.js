...
var PromptForParameters = /** @class */ (function (_super) {
                        ...
                        return [4 /*yield*/, inquirer_1.prompt([
                                {
                                    ...
                                    when: this._shouldAsk(answers, 'config.auth.token', function () {
                                        ...
                                        Logging_1.dim("It can be found here: " + _this._argv.url + "api/");
    ...
    PromptForParameters.prototype._validateAuthToken = function (input) {
        if (!input.match(/[0-9a-f]{64}/g)) {
            return 'Make sure you copied the correct auth token, it should be 64 hex chars';
        }
        return true;
    };
    PromptForParameters.prototype._validateSlug = function (input) {
    ...
    PromptForParameters.prototype._validateDSN = function (input) {
