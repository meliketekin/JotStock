...
function sample(transaction, options, samplingContext) {
    ...
    if (!isValidSampleRate(sampleRate)) {
        utils_1.isDebugBuild() && utils_1.logger.warn('[Tracing] Discarding transaction because of invalid sample rate.');
        transaction.sampled = false;
        return transaction;
    }
    ...
    utils_1.isDebugBuild() && utils_1.logger.log("[Tracing] starting " + transaction.op + " transaction - " + transaction.name);
    return transaction;
}
/**
