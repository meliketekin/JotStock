    ...
    var Logger = /** @class */ (function () {
        ...
        Logger.prototype.log = function () {
            ...
            consoleSandbox(function () {
                var _a;
                (_a = global$9.console).log.apply(_a, __spread([PREFIX + "[Log]:"], args));
            });
        };
        /** JSDoc */
        Logger.prototype.warn = function () {
            ...
            consoleSandbox(function () {
                var _a;
                (_a = global$9.console).warn.apply(_a, __spread([PREFIX + "[Warn]:"], args));
            });
        };
        /** JSDoc */
        Logger.prototype.error = function () {
            ...
            consoleSandbox(function () {
                var _a;
                (_a = global$9.console).error.apply(_a, __spread([PREFIX + "[Error]:"], args));
            });
        };
        return Logger;
    }());
    var sentryGlobal = global$9.__SENTRY__ || {};
    var logger = sentryGlobal.logger || new Logger();
    {
        // Ensure we only have a single logger instance, even if multiple versions of @sentry/utils are being used
        sentryGlobal.logger = logger;
        global$9.__SENTRY__ = sentryGlobal;
    }
