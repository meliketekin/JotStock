...
var Sentry = (function (exports) {
  ...
  class Logger {
      ...
      log(...args) {
          ...
          consoleSandbox(() => {
              global$9.console.log(`${PREFIX}[Log]:`, ...args);
          });
      }
      /** JSDoc */
      warn(...args) {
          ...
          consoleSandbox(() => {
              global$9.console.warn(`${PREFIX}[Warn]:`, ...args);
          });
      }
      /** JSDoc */
      error(...args) {
          ...
          consoleSandbox(() => {
              global$9.console.error(`${PREFIX}[Error]:`, ...args);
          });
      }
  }
  const sentryGlobal = global$9.__SENTRY__ || {};
