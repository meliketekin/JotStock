...
var Angular = /** @class */ (function () {
    ...
    function Angular(options) {
        ...
        utils_1.isDebugBuild() && utils_1.logger.log('You are still using the Angular integration, consider moving to @sentry/angular');
        // eslint-disable-next-line @typescript-eslint/no-explicit-any, @typescript-eslint/no-unsafe-member-access
        this._angular = options.angular || utils_1.getGlobalObject().angular;
        if (!this._angular) {
            utils_1.isDebugBuild() && utils_1.logger.error('AngularIntegration is missing an Angular instance');
            return;
        }
