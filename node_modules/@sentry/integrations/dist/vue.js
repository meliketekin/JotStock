...
var Vue = /** @class */ (function () {
    ...
    function Vue(options) {
        ...
        this._applyTracingHooks = function (vm, getCurrentHub) {
            ...
            _this._options.tracingOptions.hooks.forEach(function (operation) {
                ...
                if (!internalHooks) {
                    utils_1.isDebugBuild() && utils_1.logger.warn("Unknown hook: " + operation);
                    return;
                }
        ...
        utils_1.isDebugBuild() && utils_1.logger.log('You are still using the Vue.js integration, consider moving to @sentry/vue');
    ...
    Vue.prototype.setupOnce = function (_, getCurrentHub) {
        if (!this._options.Vue) {
            utils_1.isDebugBuild() && utils_1.logger.error('Vue integration is missing a Vue instance');
            return;
        }
        ...
        this._options.Vue.config.errorHandler = function (error, vm, info) {
            ...
            if (vm) {
                try {
                    ...
                    utils_1.isDebugBuild() && utils_1.logger.warn('Unable to extract metadata from Vue component.');
                }
            }
            if (info) {
